...
const Dashboard = () => {
  ...
  const cards = [
    ...
    { name: "Estimate Calculator", icon: "/icons/calculator.png", link: "/estimate-calculator" },
    { name: "Add Jobs", icon: "/icons/addjob.png", link: "/add-jobs" },
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between w-full bg-lightGray">
      ...
      <footer className="text-center p-4 w-full bg-darkGray text-lightGray">
        <p>© {new Date().getFullYear()} All rights reserved Leap.</p>
      </footer>
    </div>
  );
};
